...
仓库附带两个用于性能压测的测试存档，在 Weave 中通过「导入」加载（JSON 导入按钮，或直接把文件拖进画布）：

- **`weave_250_nodes.json`** — 250 个节点、465 条连线的常规图
- **`weave_250_fullmesh.json`** — 250 个节点、62250 条连线的全连接图，用于极端性能测试
